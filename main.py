...
def main():
    ...
    # cli(['train', '--config', 'conf/ecdp-gupopulus-train.yaml', 'gupopulus_250410'])
    # cli(['train', '--config', 'conf/ecdp-gupopulus-finetune.yaml', 'gupopulus_250409'])
    # cli(['test', '20250329-011812-parcel_s2_250329', '--save-images'])
    cli(['predict', '20250410-175524-gupopulus_250410', '--save-images'])
    cli.main()
