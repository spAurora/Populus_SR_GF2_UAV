...
class PARCEL_GF2TestDataset(Dataset):
    def __init__(self, data_dir):
        """
        Dataset for testing parcel_gf2 images.

        Args:
            data_dir (str or Path): Root directory containing the image folders.
        """
        self.hr_dir = Path(data_dir) / "parcel_gf2" / "parcel_gf2_valid_HR"
        self.lr_dir = Path(data_dir) / "parcel_gf2" / "parcel_gf2_valid_LR"
